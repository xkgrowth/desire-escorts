...
// Favicon dimensions — 32×32 is the standard browser tab size
...
export default function Icon() {
  return new ImageResponse(
    (
      ...
      >
        {/*
          Inline SVG heart rendered via an <img> tag.
          The heart paths are the same two shapes from shiny-heart.tsx,
          encoded as a data URI so ImageResponse can paint them.
        */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src={`data:image/svg+xml,${encodeURIComponent(`
            <svg width="22" height="19" viewBox="0 0 34 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
